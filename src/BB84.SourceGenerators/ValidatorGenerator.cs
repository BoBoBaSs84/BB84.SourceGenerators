...
/// <summary>
/// Responsible for generating a <c>Validate()</c> method for classes marked with the
/// <see cref="GenerateValidatorAttribute"/> attribute. The generated method scans
/// properties for data annotation attributes and emits direct validation checks.
/// </summary>
...
public sealed class ValidatorGenerator : IIncrementalGenerator
{
	...
	private void Execute(SourceProductionContext context, (ClassDeclarationSyntax ClassSyntax, SemanticModel SemanticModel)? input)
	{
		...
		sb.AppendAutoGeneratedWarning(GeneratorNames.ValidatorGeneratorFullName);
		sb.AppendNullableEnable();
		sb.AppendUsing(NamespaceNames.SystemCollectionsGeneric);
		sb.AppendUsing(NamespaceNames.SystemComponentModelDataAnnotations);
		sb.AppendUsing(NamespaceNames.SystemTextRegularExpressions);
		sb.AppendLine();
